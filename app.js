...
var $author$project$PhotoFolders$toggleExpanded = F2(
	function (path, _v0) {
		...
		if (path.$ === 'End') {
			...
			var subfolders = A2($elm$core$List$indexedMap, transform, root.subfolders);
			return $author$project$PhotoFolders$Folder(
				_Utils_update(
					root,
					{subfolders: subfolders}));
...
var $author$project$Main$viewFooter = A2(
	...
	_List_fromArray(
		[
			$elm$html$Html$text('SPA created with Elm. \nBased on \"Elm in Action\" by Richard Feldman.')
		]));
...
var $author$project$Main$viewHeader = function (page) {
	...
	var logo = A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$text('PhotoGallery')
			]));
	var links = A2(
		$elm$html$Html$ul,
		_List_Nil,
